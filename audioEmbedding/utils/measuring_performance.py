'''
@Reference: https://github.com/aldente0630/sound-anomaly-detection-with-autoencoders.git
@copyright: https://github.com/aldente0630/sound-anomaly-detection-with-autoencoders.git
'''
